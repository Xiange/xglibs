...
xdg-icon-resource forceupdate --theme Adwaita
...
useradd -m -G audio,video,tty,usb,cdrom,disk,camera,kvm,gpkg,wheel,net,dialout,systemd-journal,dhcpcd,systemd-resolve,wireshark xiange
